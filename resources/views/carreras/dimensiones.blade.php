                ...
                <div class ="col-md-12">
                    <div tabIndex="-1"  class="modal fade" id="modal_crear_dimension" aria-hidden="true">
                        <div class="modal-dialog modal-md" >
                            <form action="<?=ENV('APP_URL')?>carreras/{{$c['id']}}/dimensiones" method="POST" class="form-group">
                            @csrf
                ...
                <div class ="col-md-12">
                    <div class="modal fade" id="modal_modificar_dimension" aria-hidden="true">
                        <div class="modal-dialog modal-md" >
                            ...
                            <form method = "POST" action = "<?=ENV('APP_URL')?>carreras/{{$c['id']}}/dimensiones" class="form-group" id = "editForm">
            ...
            <div class="row">
                <div class ="col-md-12">
                    <div class="modal fade" id="modal_eliminar_dimension" aria-hidden="true">
                        <div class="modal-dialog modal-md" >
                            <form method = "POST" action = "<?=ENV('APP_URL')?>carreras/{{$c['id']}}/dimensiones" class="form-group" id = "deleteForm">
    ...
    <script>    
        $(document).ready(function() {
            ...
            table.on('click', '.edit', function() {
                ...
                $('#editForm').attr('action', '<?=ENV('APP_URL')?>carreras/{{$c['id']}}/dimensiones/'+data[0]);
            ...
            table.on('click', '.delete', function() {
                ...
                $('#deleteForm').attr('action', '<?=ENV('APP_URL')?>carreras/{{$c['id']}}/dimensiones/'+data[0]);
