            ...
            <div class="row">
                <div class ="col-md-12">
                    <div tabIndex="-1"  class="modal fade" id="modal_crear_modulo" aria-hidden="true">
                        <div class="modal-dialog modal-md" >
                            <form action="<?=ENV('APP_URL')?>carreras/{{$c['id']}}/carga_academica" method="POST" class="form-group" name="crear_modulo" id="crear_modulo">
                            @csrf
                                <div class="modal-content">
    ...
    <script>    
        $(document).ready(function() {
            ...
            table.on('click', '.edit', function() {
                ...
                $('#editForm').attr('action', '<?=ENV('APP_URL')?>carreras/{{$c['id']}}/carga_academica/'+data[0]);
            ...
            table.on('click', '.delete', function() {
                ...
                $('#deleteForm').attr('action', '<?=ENV('APP_URL')?>carreras/{{$c['id']}}/carga_academica/'+data[0]);
